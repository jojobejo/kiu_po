...
if (!function_exists('po_number_format')) {
    function po_number_format($value, $decimals = 0, $decimalSeparator = '.', $thousandsSeparator = ',')
    {
        return number_format(po_num($value), $decimals, $decimalSeparator, $thousandsSeparator);
    }
}
